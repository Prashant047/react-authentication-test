...
var _NoteCard = __webpack_require__(87);

var _NewNoteTemplate = __webpack_require__(88);
...
var UserPage = function (_Component) {
    ...
    _createClass(UserPage, [{
        ...
        key: 'submitNewNote',
        value: function submitNewNote(data) {
            console.log(data);
        }
    }, {
        key: 'render',
        value: function render() {
            var getNotes = this.state.notes.map(function (note, index) {
                return _react2.default.createElement(_NoteCard.NoteCard, { cardTitle: note.title, cardContent: note.body, key: index, cardId: index });
            });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    getNotes,
                    _react2.default.createElement(_NewNoteTemplate.NewNoteTemplate, {
...
var _UserPage = __webpack_require__(37);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        key: 'isAuthenticated',
        value: function isAuthenticated(value, userData) {
            if (value) {
        ...
        value: function render() {
            ...
            var PrivateRoute = function PrivateRoute(_ref) {
                var PComponent = _ref.component,
                    rest = _objectWithoutProperties(_ref, ['component']);

                return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
                        return _this2.state.auth ? _react2.default.createElement(PComponent, _extends({}, props, { userData: _this2.state.userData })) : _react2.default.createElement(_reactRouterDom.Redirect, { to: '/login' });
                    } }));
            };

            var login_signup = function login_signup() {
                if (_this2.state.auth) {
                    return _react2.default.createElement(
                        'ul',
                        null,
                        _react2.default.createElement(
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/login', exact: true, render: function render() {
                            return _react2.default.createElement(_Login.Login, { isAuthenticated: _this2.isAuthenticated });
                        } }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/signup', exact: true, component: _Signup.SignUp }),
                    _react2.default.createElement(PrivateRoute, { path: '/userpage', component: _UserPage.UserPage })
                )
            );
        }
    }]);
                ...
                if (_this2.state.isEditing) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement('textarea', {
                            ...
                            onChange: _this2.onChangeContent
                        })
                    );
                }
            ...
            var footer = function footer() {
                if (_this2.state.isEditing) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { className: 'card-footer-item', onClick: _this2.onClickSave },
                            'Save'
                        ),
                        _react2.default.createElement(
                            'a',
                            { className: 'card-footer-item', onClick: _this2.onClickCancel },
                            'Cancel'
                        )
                    );
                }
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { className: 'card-footer-item', onClick: _this2.onClickEdit },
                        'Edit'
                    ),
                    _react2.default.createElement(
                        'a',
...
exports.NewNoteTemplate = undefined;
...
var NewNoteTemplate = function (_Component) {
    _inherits(NewNoteTemplate, _Component);

    function NewNoteTemplate() {
        _classCallCheck(this, NewNoteTemplate);

        var _this = _possibleConstructorReturn(this, (NewNoteTemplate.__proto__ || Object.getPrototypeOf(NewNoteTemplate)).call(this));
    ...
    _createClass(NewNoteTemplate, [{
        ...
        value: function render() {
            ...
            var aemplate = function aemplate() {
                if (_this2.state.addingNew) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'card' },
                        _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'card-content is-marginless is-paddingless' },
                            _react2.default.createElement(
                                'div',
                                { className: 'content' },
                                _react2.default.createElement('textarea', {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '#', className: 'card-footer-item', onClick: _this2.onSave },
                                'Save'
                            ),
                            _react2.default.createElement(
                                'a',
                                { href: '#', className: 'card-footer-item', onClick: _this2.onCancel },
                                'Cancel'
                            )
                        )
                    );
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { className: 'button is-large is-primary is-outlined', onClick: _this2.toggleView },
                        'Add'
                    )
                );
            };
...
exports.NewNoteTemplate = NewNoteTemplate;
...
var _emailValidator = __webpack_require__(38);
            ...
            if (this.state.isEmailValid) {
                ...
                _axios2.default.post('/auth/login', {
                    ...
                    if (res.data.success) {
                        ...
                        _this2.setState({ serverMessage: res.data.message });
                        _this2.setState({ isDone: true });
                        _this2.setState({ isLoading: false });
                        _this2.props.isAuthenticated(true, res.data.userData);
                    } else {
        ...
        value: function render() {
            ...
            var btn = function btn() {
                if (_this3.state.isDone) {
                    ...
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-large is-primary is-loading' },
                        'Login'
                    );
                } else if (_this3.state.isFilled) {
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-large is-primary', onClick: _this3.onBtnClick },
                        'Login'
                    );
                } else {
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-large is-primary', disabled: true },
                        'Login'
                    );
                }
            };

            var emailMessage = function emailMessage() {
                if (_this3.state.email.length == 0) {
                    return _react2.default.createElement(
                        'p',
                        { className: 'help' },
                        'Enter your registered email-id'
                    );
                } else if (_this3.state.isEmailValid) {
                    return _react2.default.createElement(
                        'p',
                        { className: 'help is-success' },
                        'This email-id is valid'
                    );
                } else {
                    return _react2.default.createElement(
                        'p',
                        { className: 'help is-danger' },
                        'This email-id is invalid'
                    );
                }
            };
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('input', {
                                className: 'input ' + (this.state.email.length ? this.state.isEmailValid ? 'is-success' : 'is-danger' : ''),
                                type: 'email',
                                placeholder: 'Email',
            ...
            if (this.state.isEmailValid) {
                ...
                _axios2.default.post('/auth/signup', {
                    ...
                    if (response.status == 200) {
                        _this2.setState({ isDone: true });
                        _this2.setState({ serverMessage: response.data.message });
                        setTimeout(function () {
        ...
        value: function render() {
            ...
            var btn = function btn() {
                if (_this3.state.isDone) {
                    ...
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-medium is-primary is-loading' },
                        'Submit'
                    );
                } else if (_this3.state.isFilled) {
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-medium is-primary', onClick: _this3.onClickHandler },
                        'Submit'
                    );
                } else {
                    return _react2.default.createElement(
                        'a',
                        { className: 'button is-medium is-primary', disabled: true },
                        'Submit'
                    );
                }
            };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'h4',
                            { className: 'subtitle has-text-success' },
                            this.state.serverMessage
                        )
                    ),
                    _react2.default.createElement(
